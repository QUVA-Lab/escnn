...
def klein4_group():
    ...
    Builds the group :math:`K_4 = C_2 \times C_2`. This group is most commonly associated with the symmetries of the
    square. I.e. a group generated by two perpendicular reflection and a rotation of 180 degrees.
    The returned group instance has an additional representation named `square`, which is the 2D representation of the
    square symmetries.
    ...
    # Klein4 group is mostly associated with the symmetries of the square (2 perpendicular reflections (gx, gy) and a
    # 180 deg rotation (gx · gy) in 2D space. We add this representation, constructed from the irreps of the group.
    # rep2d_square(e) = [[1, 0], [0, 1]], rep2d_square(gx) = [[-1, 0], [0, 1]],
    # rep2d_square(gy) = [[1, 0], [0, -1]] rep2d_square(gx · gy) = [[-1, 0], [0, -1]]
    rep2d_square = K4.irrep((1,), (0,)) + K4.irrep((0,), (1,))
    K4.representations.update(square=rep2d_square)
    return K4
